...
@Entity
@Table(
    name = "dashboard_bulletin_board",
    indexes = [
        Index(name = "idx_dashboard_bulletin_board_user_id", columnList = "user_id"),
        Index(name = "idx_dashboard_bulletin_board_title", columnList = "title")
    ]
)
